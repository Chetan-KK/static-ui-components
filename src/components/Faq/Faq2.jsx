        ...
        {contents.map((content, i) => (
          ...
          >
            <Button
              ...
              className="flex gap-2 font-bold text-left justify-start items-center w-full p-2"
            >
              {openIndex === i ? (
                <Minus
                  className={`text-[#005cf0] size-5 transition-transform duration-300`}
                />
              ) : (
                <Plus
                  className={`text-[#005cf0] size-5 transition-transform duration-300`}
            ...
            >
              <p className="p-2 text-[#4d4d4d] dark:text-[#ababab] text-sm sm:text-base border-l border-[#005cf0] ml-10 mt-2">
                {content.a}
              </p>
            </div>
          </div>
