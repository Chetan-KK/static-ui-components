    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      <div className="text-center">
        <img
          ...
          className="mx-auto w-[90vw] lg:w-[60rem] h-96 md:h-[40rem] object-cover rounded-xl mb-14"
          alt="hero image"
        />
        <SectionHeading
        ...
        />
        <div className="mt-10 mx-auto flex items-center flex-wrap px-5 sm:px-10 lg:px-40 justify-start sm:justify-center gap-3">
