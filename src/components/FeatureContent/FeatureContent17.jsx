    ...
    <div className="py-10">
      ...
      <div className="container mx-auto my-16 grid grid-cols-1 sm:grid-cols-2 sm:place-items-center lg:grid-cols-4 p-2 sm:p-5 gap-5 gap-y-10">
        {contents.map((content, i) => (
          <div
            key={i}
            className="flex gap-3 flex-col text-center items-center border border-[#f0f0f0] dark:border-[#252528] rounded-xl p-2 px-4"
          >
...
export default FeatureContent17;
