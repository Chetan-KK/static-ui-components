    ...
    <div className="py-10">
      ...
      <div className="container mx-auto my-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-2 sm:p-5 gap-5 gap-y-10 lg:px-20 items-start cursor-pointer">
        {contents.map((content, i) => (
          <div
            key={i}
            className="grid grid-rows-[15rem_auto] hover:-translate-y-1 border border-[#f0f0f0] dark:border-[#252528] rounded-xl hover:shadow-[#005cf0]/30 shadow-lg transition-all duration-500 gap-5"
          >
            <img
              src={content.imgSrc}
...
export default FeatureContent10;
